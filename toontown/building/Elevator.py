...
class Elevator(StateData.StateData):
    ...
    def enableExitButton(self):
        self.exitButton = DirectButton(relief = None, text = TTLocalizer.ElevatorHopOff, text_fg = (0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), text_pos = (0, -0.23000000000000001), text_scale = TTLocalizer.EexitButton, image = (self.upButton, self.downButton, self.rolloverButton), image_color = (0.5, 0.5, 0.5, 1), image_scale = (20, 1, 11), pos = (0, 0, 0.80000000000000004), scale = 0.14999999999999999, command = lambda self = self: self.fsm.request('requestExit'))
        ...
        if self.distElevator.antiShuffle:
            self.hopWarning = DirectLabel(parent = self.exitButton, relief = None, pos = Vec3(0, 0, 0.0), text = TTLocalizer.ElevatorStayOff, text_fg = (0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), text_pos = (0, -1.1000000000000001), text_scale = 0.59999999999999998)
