...
class BoardingGroupShow:
    ...
    def getBoardingTrack(self, elevatorModel, offset, offsetWrtRender, wantToonRotation):
        ...
        if self.toon:
            ...
            isInThresholdDist = self._BoardingGroupShow__isInThresholdDist(elevatorModel, offset, self.thresholdRunDistance)
            isRunPathClear = self._BoardingGroupShow__isRunPathClear(elevatorModel, offsetWrtRender)
            if isInThresholdDist and isRunPathClear:
                boardingTrack.append(self._BoardingGroupShow__getRunTrack(elevatorModel, offset, wantToonRotation))
                trackType = TRACK_TYPE_RUN
            elif self.toon.isDisguised:
                boardingTrack.append(self._BoardingGroupShow__getPoofTeleportTrack(elevatorModel, offset, wantToonRotation))
                trackType = TRACK_TYPE_POOF
            else:
                boardingTrack.append(self._BoardingGroupShow__getTeleportTrack(elevatorModel, offset, wantToonRotation))
    ...
    def _BoardingGroupShow__getTeleportTrack(self, elevatorModel, offset, wantToonRotation):
    ...
    def _BoardingGroupShow__getPoofTeleportTrack(self, elevatorModel, offset, wantToonRotation):
        teleportTrack = Sequence()
        if wantToonRotation:
            teleportTrack.append(Func(self.toon.headsUp, elevatorModel, offset))
    ...
    def _BoardingGroupShow__getRunTrack(self, elevatorModel, offset, wantToonRotation):
        runTrack = Sequence()
        if self.toon:
            if wantToonRotation:
    ...
    def _BoardingGroupShow__isInThresholdDist(self, elevatorModel, offset, thresholdDist):
    ...
    def _BoardingGroupShow__isRunPathClear(self, elevatorModel, offsetWrtRender):
        pathClear = True
