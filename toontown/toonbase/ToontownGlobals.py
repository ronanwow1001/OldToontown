...
global ToonFont, BuildingNametagFont, MinnieFont, SuitFont
import TTLocalizer
...
Hoods = (DonaldsDock, ToontownCentral, TheBrrrgh, MinniesMelodyland, DaisyGardens, OutdoorZone, FunnyFarm, GoofySpeedway, DonaldsDreamland, BossbotHQ, SellbotHQ, CashbotHQ, LawbotHQ, GolfZone)
HoodsForTeleportAll = (DonaldsDock, ToontownCentral, TheBrrrgh, MinniesMelodyland, DaisyGardens, OutdoorZone, GoofySpeedway, DonaldsDreamland, BossbotHQ, SellbotHQ, CashbotHQ, LawbotHQ, GolfZone)
NoPreviousGameId = 0
RaceGameId = 1
CannonGameId = 2
TagGameId = 3
...
MinigamePlayerMatrix = {
    1: (CannonGameId, RingGameId, MazeGameId, TugOfWarGameId, CatchGameId, DivingGameId, TargetGameId, PairingGameId, VineGameId, CogThiefGameId, TwoDGameId),
    2: (CannonGameId, PatternGameId, RingGameId, TagGameId, MazeGameId, TugOfWarGameId, CatchGameId, DivingGameId, TargetGameId, PairingGameId, VineGameId, IceGameId, CogThiefGameId, TwoDGameId),
    3: (CannonGameId, PatternGameId, RingGameId, TagGameId, RaceGameId, MazeGameId, TugOfWarGameId, CatchGameId, DivingGameId, TargetGameId, PairingGameId, VineGameId, IceGameId, CogThiefGameId, TwoDGameId),
    4: (CannonGameId, PatternGameId, RingGameId, TagGameId, RaceGameId, MazeGameId, TugOfWarGameId, CatchGameId, DivingGameId, TargetGameId, PairingGameId, VineGameId, IceGameId, CogThiefGameId, TwoDGameId) }
...
LawbotBossChairRow1PosA = (59.299999999999997, -18.199999999999999, 14.050000000000001)
LawbotBossChairRow2PosB = (75.099999999999994, 48, 28.199999999999999)
LawbotBossChairRow2PosA = (75.099999999999994, -18.199999999999999, 28.199999999999999)
...
GlitchKillerZones = [
    ...
    13500,
    13600]
ColorPlayer = (0.29999999999999999, 0.69999999999999996, 0.29999999999999999, 1)
ColorAvatar = (0.29999999999999999, 0.29999999999999999, 0.69999999999999996, 1)
ColorPet = (0.59999999999999998, 0.40000000000000002, 0.20000000000000001, 1)
ColorFreeChat = (0.29999999999999999, 0.29999999999999999, 0.80000000000000004, 1)
ColorSpeedChat = (0.20000000000000001, 0.59999999999999998, 0.40000000000000002, 1)
