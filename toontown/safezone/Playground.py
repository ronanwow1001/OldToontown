...
class Playground(Place.Place):
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if self.dialog:
            ...
            if (Quests.avatarHasTrolleyQuest(base.localAvatar) and Quests.avatarHasFirstCogQuest(base.localAvatar) and Quests.avatarHasFriendQuest(base.localAvatar) or Quests.avatarHasPhoneQuest(base.localAvatar) or Quests.avatarHasCompletedPhoneQuest(base.localAvatar)) and self.loader.hood.id == ToontownGlobals.ToontownCentral:
                requestStatus['nextState'] = 'popup'
