...
class DistributedFishingSpot(DistributedObject.DistributedObject):
    ...
    def _DistributedFishingSpot__showCastGui(self):
        ...
        self.accept(localAvatar.uniqueName('fishTankChange'), self._DistributedFishingSpot__updateFishTankGui)
    ...
    def _DistributedFishingSpot__makeGui(self):
        ...
        self.itemFrame = DirectFrame(parent = self.itemGui, relief = None, geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (1, 1, 0.59999999999999998), text = TTLocalizer.FishingItemFound, text_pos = (0, 0.20000000000000001), text_scale = 0.080000000000000002, pos = (0, 0, 0.58699999999999997))
