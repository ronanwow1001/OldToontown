...
class GZPlayground(Playground.Playground):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm.addState(State.State('golfKartBlock', self.enterGolfKartBlock, self.exitGolfKartBlock, [
            'walk']))
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if reason == RaceGlobals.Exit_Barrier:
            ...
            self.dialog = TTDialog.TTDialog(text = TTLocalizer.KartRace_RaceTimeout, command = self._GZPlayground__cleanupDialog, style = TTDialog.Acknowledge)
        elif reason == RaceGlobals.Exit_Slow:
            requestStatus['nextState'] = 'popup'
            self.dialog = TTDialog.TTDialog(text = TTLocalizer.KartRace_RacerTooSlow, command = self._GZPlayground__cleanupDialog, style = TTDialog.Acknowledge)
        elif reason == RaceGlobals.Exit_BarrierNoRefund:
            requestStatus['nextState'] = 'popup'
            self.dialog = TTDialog.TTDialog(text = TTLocalizer.KartRace_RaceTimeoutNoRefund, command = self._GZPlayground__cleanupDialog, style = TTDialog.Acknowledge)
