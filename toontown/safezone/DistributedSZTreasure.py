...
class DistributedSZTreasure(DistributedTreasure.DistributedTreasure):
    ...
    def replaceTreasure(self, newModelPath):
        ...
        def getFadeOutTrack():
            fadeOutTrack = LerpColorScaleInterval(self.nodePath, 0.80000000000000004, colorScale = VBase4(0, 0, 0, 0), startColorScale = VBase4(1, 1, 1, 1), blendType = 'easeIn')
            return fadeOutTrack
    ...
    def startAnimation(self):
        ...
        if ToontownGlobals.VALENTINES_DAY in holidayIds:
            ...
            throbScale = VBase3(0.84999999999999998, 0.84999999999999998, 0.84999999999999998)
            throbInIval = LerpScaleInterval(self.nodePath, 0.29999999999999999, scale = throbScale, startScale = originalScale, blendType = 'easeIn')
            throbOutIval = LerpScaleInterval(self.nodePath, 0.29999999999999999, scale = originalScale, startScale = throbScale, blendType = 'easeOut')
