...
class Place(StateData.StateData, FriendsListManager.FriendsListManager):
    ...
    def exitWalk(self):
        ...
        if base.cr.productName in [
            'DisneyOnline-US',
            'ES'] and not base.cr.isPaid() and base.localAvatar.tutorialAck and not (base.cr.whiteListChatEnabled):
    ...
    def _Place__handleBook(self):
        ...
        if bookStatus['mode'] == 'close':
            ...
            base.localAvatar.collisionsOff()
            base.localAvatar.b_setAnimState('CloseBook', 1, callback = self.startPartyNow, extraArgs = [
                firstStart,
                hostId])
    ...
    def enterBanking(self):
        ...
        base.localAvatar.laffMeter.start()
        base.localAvatar.obscureMoveFurnitureButton(1)
        base.localAvatar.startSleepWatch(self._Place__handleFallingAsleepBanking)
        self.enablePeriodTimer()
    ...
    def enterStopped(self):
        ...
        base.localAvatar.laffMeter.start()
        base.localAvatar.obscureMoveFurnitureButton(1)
        base.localAvatar.startSleepWatch(self._Place__handleFallingAsleepStopped)
        self.enablePeriodTimer()
