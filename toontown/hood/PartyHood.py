...
class PartyHood(Hood.Hood):
    ...
    def _PartyHood__popupKickoutMessage(self, msg):
        ...
        self.popupInfo = DirectFrame(parent = hidden, relief = None, state = 'normal', text = msg, frameSize = (-1, 1, -1, 1), text_wordwrap = 10, geom = DGG.getDefaultDialogGeom(), geom_color = GlobalDialogColor, geom_scale = (0.88, 1, 0.75), geom_pos = (0, 0, -0.080000000000000002), text_scale = 0.080000000000000002, text_pos = (0, 0.10000000000000001))
        DirectButton(self.popupInfo, image = okButtonImage, relief = None, text = TTLocalizer.EstatePopupOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.29999999999999999), command = self._PartyHood__handleKickoutOk)
        buttons.removeNode()
