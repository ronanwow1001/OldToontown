...
class EstateHood(Hood.Hood):
    ...
    def _EstateHood__popupKickoutMessage(self, msg):
        ...
        self.popupInfo = DirectFrame(parent = hidden, relief = None, state = 'normal', text = msg, frameSize = (-1, 1, -1, 1), text_wordwrap = 10, geom = DGG.getDefaultDialogGeom(), geom_color = GlobalDialogColor, geom_scale = (0.88, 1, 0.75), geom_pos = (0, 0, -0.080000000000000002), text_scale = TTLocalizer.EHpopupInfo, text_pos = (0, 0.10000000000000001))
