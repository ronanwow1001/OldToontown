...
class BodyShop(StateData.StateData):
    ...
    def load(self):
        ...
        self.parentFrame = DirectFrame(relief = DGG.RAISED, pos = (0.97999999999999998, 0, 0.41599999999999998), frameColor = (1, 0, 0, 0))
        self.speciesFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame, image_scale = halfButtonInvertScale, relief = None, pos = (0, 0, -0.072999999999999995), hpr = (0, 0, 0), scale = 1.3, frameColor = (1, 1, 1, 1), text = 'Species', text_scale = 0.0625, text_pos = (-0.001, -0.014999999999999999), text_fg = (1, 1, 1, 1))
        self.speciesLButton = DirectButton(parent = self.speciesFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-0.20000000000000001, 0, 0), command = self._BodyShop__swapSpecies, extraArgs = [
            -1])
        self.speciesRButton = DirectButton(parent = self.speciesFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonInvertScale, image1_scale = halfButtonInvertHoverScale, image2_scale = halfButtonInvertHoverScale, pos = (0.20000000000000001, 0, 0), command = self._BodyShop__swapSpecies, extraArgs = [
            1])
        self.headFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame, image_scale = halfButtonInvertScale, relief = None, pos = (0, 0, -0.29999999999999999), hpr = (0, 0, 2), scale = 0.90000000000000002, frameColor = (1, 1, 1, 1), text = TTLocalizer.BodyShopHead, text_scale = 0.0625, text_pos = (-0.001, -0.014999999999999999), text_fg = (1, 1, 1, 1))
        self.headLButton = DirectButton(parent = self.headFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-0.20000000000000001, 0, 0), command = self._BodyShop__swapHead, extraArgs = [
            -1])
        self.headRButton = DirectButton(parent = self.headFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonInvertScale, image1_scale = halfButtonInvertHoverScale, image2_scale = halfButtonInvertHoverScale, pos = (0.20000000000000001, 0, 0), command = self._BodyShop__swapHead, extraArgs = [
            1])
        self.bodyFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame, image_scale = halfButtonScale, relief = None, pos = (0, 0, -0.5), hpr = (0, 0, -2), scale = 0.90000000000000002, frameColor = (1, 1, 1, 1), text = TTLocalizer.BodyShopBody, text_scale = 0.0625, text_pos = (-0.001, -0.014999999999999999), text_fg = (1, 1, 1, 1))
        self.torsoLButton = DirectButton(parent = self.bodyFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-0.20000000000000001, 0, 0), command = self._BodyShop__swapTorso, extraArgs = [
            -1])
        self.torsoRButton = DirectButton(parent = self.bodyFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonInvertScale, image1_scale = halfButtonInvertHoverScale, image2_scale = halfButtonInvertHoverScale, pos = (0.20000000000000001, 0, 0), command = self._BodyShop__swapTorso, extraArgs = [
            1])
        self.legsFrame = DirectFrame(parent = self.parentFrame, image = shuffleFrame, image_scale = halfButtonInvertScale, relief = None, pos = (0, 0, -0.69999999999999996), hpr = (0, 0, 3), scale = 0.90000000000000002, frameColor = (1, 1, 1, 1), text = TTLocalizer.BodyShopLegs, text_scale = 0.0625, text_pos = (-0.001, -0.014999999999999999), text_fg = (1, 1, 1, 1))
        self.legLButton = DirectButton(parent = self.legsFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-0.20000000000000001, 0, 0), command = self._BodyShop__swapLegs, extraArgs = [
            -1])
        self.legRButton = DirectButton(parent = self.legsFrame, relief = None, image = (shuffleArrowUp, shuffleArrowDown, shuffleArrowRollover, shuffleArrowDisabled), image_scale = halfButtonInvertScale, image1_scale = halfButtonInvertHoverScale, image2_scale = halfButtonInvertHoverScale, pos = (0.20000000000000001, 0, 0), command = self._BodyShop__swapLegs, extraArgs = [
            1])
        self.memberButton = DirectButton(relief = None, image = (upsellTex, upsellTex, upsellTex, upsellTex), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, scale = 0.90000000000000002, pos = (0, 0, -0.83999999999999997), command = self._BodyShop__restrictForward)
        self.parentFrame.hide()
        self.memberButton.hide()
    ...
    def _BodyShop__swapSpecies(self, offset):
        ...
        self._BodyShop__updateScrollButtons(self.speciesChoice, length, self.speciesStart, self.speciesLButton, self.speciesRButton)
    ...
    def _BodyShop__updateHead(self):
        self._BodyShop__updateScrollButtons(self.headChoice, len(self.headList), self.headStart, self.headLButton, self.headRButton)
