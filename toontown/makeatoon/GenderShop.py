...
class GenderShop(StateData.StateData):
    ...
    def load(self):
        ...
        self.boyButton = DirectButton(relief = None, image = (guiBoyUp, guiBoyDown, guiBoyUp, guiBoyDown), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-0.40000000000000002, 0, -0.80000000000000004), command = self.createRandomBoy, text = ('', TTLocalizer.GenderShopBoyButtonText, TTLocalizer.GenderShopBoyButtonText, ''), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_pos = (0, 0.19), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.boyButton.hide()
        self.girlButton = DirectButton(relief = None, image = (guiGirlUp, guiGirlDown, guiGirlUp, guiGirlDown), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (0.40000000000000002, 0, -0.80000000000000004), command = self.createRandomGirl, text = ('', TTLocalizer.GenderShopGirlButtonText, TTLocalizer.GenderShopGirlButtonText, ''), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_pos = (0, 0.19), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
