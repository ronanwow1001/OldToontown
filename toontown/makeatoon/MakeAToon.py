...
class MakeAToon(StateData.StateData):
    ...
    def enter(self):
        ...
        camera.setPosHpr(-5.7000000000000002, -12.350099999999999, 2.1499999999999999, -24.849900000000002, 2.73, 0)
        if self.warp:
    ...
    def load(self):
        ...
        self.guiTopBar = DirectFrame(relief = None, text = TTLocalizer.CreateYourToon, text_font = ToontownGlobals.getSignFont(), text_fg = (0.0, 0.65000000000000002, 0.34999999999999998, 1), text_scale = 0.17999999999999999, text_pos = (0, -0.029999999999999999), pos = (0, 0, 0.85999999999999999))
        self.guiTopBar.hide()
        self.guiBottomBar = DirectFrame(relief = None, image_scale = (1.25, 1, 1), pos = (0.01, 0, -0.85999999999999999))
        self.guiBottomBar.hide()
        self.guiCheckButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (guiAcceptUp, guiAcceptDown, guiAcceptUp, guiAcceptDown), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (1.165, 0, -0.017999999999999999), command = self._MakeAToon__handleNext, text = ('', TTLocalizer.MakeAToonDone, TTLocalizer.MakeAToonDone), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_align = TextNode.ARight, text_pos = (0.13, 0.13), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.guiCheckButton.hide()
        self.guiCancelButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (guiCancelUp, guiCancelDown, guiCancelUp, guiCancelDown), image_scale = halfButtonScale, image1_scale = halfButtonHoverScale, image2_scale = halfButtonHoverScale, pos = (-1.179, 0, -0.010999999999999999), command = self._MakeAToon__handleCancel, text = ('', TTLocalizer.MakeAToonCancel, TTLocalizer.MakeAToonCancel), text_font = ToontownGlobals.getInterfaceFont(), text_scale = TTLocalizer.MATguiCancelButton, text_pos = (0, 0.115), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.guiCancelButton.hide()
        self.guiNextButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (guiNextUp, guiNextDown, guiNextUp, guiNextDisabled), image_scale = (0.29999999999999999, 0.29999999999999999, 0.29999999999999999), image1_scale = (0.34999999999999998, 0.34999999999999998, 0.34999999999999998), image2_scale = (0.34999999999999998, 0.34999999999999998, 0.34999999999999998), pos = (1.165, 0, -0.017999999999999999), command = self._MakeAToon__handleNext, text = ('', TTLocalizer.MakeAToonNext, TTLocalizer.MakeAToonNext, ''), text_font = ToontownGlobals.getInterfaceFont(), text_scale = TTLocalizer.MATguiNextButton, text_pos = (0, 0.115), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.guiNextButton.hide()
        self.guiLastButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (guiNextUp, guiNextDown, guiNextUp, guiNextDown), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), image_scale = (-0.29999999999999999, 0.29999999999999999, 0.29999999999999999), image1_scale = (-0.34999999999999998, 0.34999999999999998, 0.34999999999999998), image2_scale = (-0.34999999999999998, 0.34999999999999998, 0.34999999999999998), pos = (0.82499999999999996, 0, -0.017999999999999999), command = self._MakeAToon__handleLast, text = ('', TTLocalizer.MakeAToonLast, TTLocalizer.MakeAToonLast, ''), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_pos = (0, 0.115), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.guiLastButton.hide()
        self.rotateLeftButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (rotateUp, rotateDown, rotateUp, rotateDown), image_scale = (-0.40000000000000002, 0.40000000000000002, 0.40000000000000002), image1_scale = (-0.5, 0.5, 0.5), image2_scale = (-0.5, 0.5, 0.5), pos = (-0.32924900000000001, 0, 0.202961))
        ...
        self.rotateRightButton = DirectButton(parent = self.guiBottomBar, relief = None, image = (rotateUp, rotateDown, rotateUp, rotateDown), image_scale = (0.40000000000000002, 0.40000000000000002, 0.40000000000000002), image1_scale = (0.5, 0.5, 0.5), image2_scale = (0.5, 0.5, 0.5), pos = (0.30953399999999998, 0, 0.20611599999999999))
    ...
    def enterGenderShop(self):
        ...
        self.guiTopBar['text_fg'] = (1, 0.92000000000000004, 0.20000000000000001, 1)
