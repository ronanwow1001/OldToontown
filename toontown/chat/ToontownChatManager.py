...
class ToontownChatManager(ChatManager.ChatManager):
    ...
    def __init__(self, cr, localAvatar):
        ...
        self.speedChatPlusPos = Vec3(-0.34999999999999998, 0, 0.70999999999999996)
    ...
    def enterOpenChatWarning(self):
        if self.openChatWarning == None:
            ...
            self.openChatWarning = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.20000000000000001), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.2, 1.0, 1.3999999999999999), text = OTPLocalizer.OpenChatWarning, text_wordwrap = 19, text_scale = TTLocalizer.TCMopenChatWarning, text_pos = (0.0, 0.57499999999999996), textMayChange = 0)
            DirectButton(self.openChatWarning, image = buttonImage, relief = None, text = OTPLocalizer.OpenChatWarningOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.55000000000000004), command = self._ToontownChatManager__handleOpenChatWarningOK)
            buttons.removeNode()
    ...
    def enterUnpaidChatWarning(self):
        ...
        if self.unpaidChatWarning == None:
            ...
            self.unpaidChatWarning = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.40000000000000002), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.2, 1.0, 0.80000000000000004), text = directFrameText, text_wordwrap = TTLocalizer.TCMunpaidChatWarningWordwrap, text_scale = TTLocalizer.TCMunpaidChatWarning, text_pos = TTLocalizer.TCMunpaidChatWarningPos, textMayChange = 0)
            self.payButton = DirectButton(self.unpaidChatWarning, image = buttonImage, relief = None, text = payButtonText, image_scale = (1.75, 1, 1.1499999999999999), text_scale = TTLocalizer.TCMpayButton, text_pos = (0, -0.02), textMayChange = 0, pos = TTLocalizer.TCMpayButtonPos, command = self._ToontownChatManager__handleUnpaidChatWarningPay)
            DirectButton(self.unpaidChatWarning, image = buttonImage, relief = None, text = directButtonText, textMayChange = 0, image_scale = (1.75, 1, 1.1499999999999999), text_scale = 0.059999999999999998, text_pos = (0, -0.02), pos = TTLocalizer.TCMdirectButtonTextPos, command = self._ToontownChatManager__handleUnpaidChatWarningContinue)
    ...
    def enterNoSecretChatAtAll(self):
        if self.noSecretChatAtAll == None:
            ...
            self.noSecretChatAtAll = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.20000000000000001), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.3999999999999999, 1.0, 1.1000000000000001), text = OTPLocalizer.NoSecretChatAtAll, text_wordwrap = 20, textMayChange = 0, text_scale = 0.059999999999999998, text_pos = (0, 0.29999999999999999))
            DirectLabel(parent = self.noSecretChatAtAll, relief = None, pos = (0, 0, 0.40000000000000002), text = OTPLocalizer.NoSecretChatAtAllTitle, textMayChange = 0, text_scale = 0.080000000000000002)
            DirectButton(self.noSecretChatAtAll, image = okButtonImage, relief = None, text = OTPLocalizer.NoSecretChatAtAllOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.40000000000000002), command = self._ToontownChatManager__handleNoSecretChatAtAllOK)
            buttons.removeNode()
    ...
    def enterNoSecretChatWarning(self, passwordOnly = 0):
        ...
        if self.noSecretChatWarning == None:
            ...
            self.noSecretChatWarning = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.20000000000000001), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.3999999999999999, 1.0, 1.0), text = warningText, text_wordwrap = 20, text_scale = 0.055, text_pos = textPos, textMayChange = 1)
    ...
    def enterActivateChat(self):
        if self.activateChatGui == None:
            ...
            self.activateChatGui = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.20000000000000001), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.8, 1.0, 1.6000000000000001), text = OTPLocalizer.ActivateChat, text_align = TextNode.ALeft, text_wordwrap = 33, text_scale = TTLocalizer.TCMactivateChatGui, text_pos = (-0.81999999999999995, 0.57999999999999996), textMayChange = 0)
            ...
            DirectLabel(self.activateChatGui, relief = None, text = OTPLocalizer.ActivateChatTitle, text_align = TextNode.ACenter, text_scale = 0.070000000000000007, text_pos = (0, 0.69999999999999996), textMayChange = 0)
            if base.cr.productName != 'JP':
                DirectButton(self.activateChatGui, image = moreButtonImage, image_scale = (1.25, 1.0, 1.0), relief = None, text = OTPLocalizer.ActivateChatMoreInfo, text_scale = 0.059999999999999998, text_pos = (0, -0.02), textMayChange = 0, pos = (0.0, 0.0, -0.69999999999999996), command = self._ToontownChatManager__handleActivateChatMoreInfo)
            
            self.dcb1 = HackedDirectRadioButton(parent = self.activateChatGui, relief = None, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = (-0.745, 0, 0.29699999999999999), command = self._ToontownChatManager__updateCheckBoxen, extraArgs = [
                1])
            self.dcb2 = HackedDirectRadioButton(parent = self.activateChatGui, relief = None, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = (-0.745, 0, 0.14699999999999999), command = self._ToontownChatManager__updateCheckBoxen, extraArgs = [
                2])
            self.dcb3 = HackedDirectRadioButton(parent = self.activateChatGui, relief = None, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = (-0.745, 0, -0.0030000000000000001), command = self._ToontownChatManager__updateCheckBoxen, extraArgs = [
                3])
            DirectButton(self.activateChatGui, image = okButtonImage, relief = None, text = OTPLocalizer.ActivateChatYes, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (-0.34999999999999998, 0.0, -0.27000000000000002), command = self._ToontownChatManager__handleActivateChatYes)
            DirectButton(self.activateChatGui, image = cancelButtonImage, relief = None, text = OTPLocalizer.ActivateChatNo, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.34999999999999998, 0.0, -0.27000000000000002), command = self._ToontownChatManager__handleActivateChatNo)
            guiButton.removeNode()
            buttons.removeNode()
    ...
    def enterSecretChatActivated(self, mode = 2):
        ...
        if self.secretChatActivated == None:
            ...
            buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
            buttonImage = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr'))
            self.secretChatActivated = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.40000000000000002), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.0, 1.0, 0.80000000000000004), text = modeText, text_align = TextNode.ACenter, text_wordwrap = 14, text_scale = TTLocalizer.TCMsecretChatActivated, text_pos = (0, 0.25))
    ...
    def _ToontownChatManager__whisperButtonPressed(self, avatarName, avatarId, playerId):
        messenger.send('wakeup')
        playerInfo = None
        if playerId:
    ...
    def enterNoSecretChatAtAllAndNoWhitelist(self):
        if self.noSecretChatAtAllAndNoWhitelist == None:
            buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
            okButtonImage = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr'))
            self.noSecretChatAtAllAndNoWhitelist = DirectFrame(parent = aspect2dp, pos = (0.0, 0.10000000000000001, 0.050000000000000003), relief = None, image = DGG.getDefaultDialogGeom(), image_color = OTPGlobals.GlobalDialogColor, image_scale = (1.3999999999999999, 1.0, 1.5800000000000001), text = OTPLocalizer.NoSecretChatAtAllAndNoWhitelist, text_wordwrap = 20, textMayChange = 0, text_scale = 0.059999999999999998, text_pos = (0, 0.55000000000000004))
            DirectLabel(parent = self.noSecretChatAtAllAndNoWhitelist, relief = None, pos = (0, 0, 0.67000000000000004), text = OTPLocalizer.NoSecretChatAtAllAndNoWhitelistTitle, textMayChange = 0, text_scale = 0.080000000000000002)
            DirectButton(self.noSecretChatAtAllAndNoWhitelist, image = okButtonImage, relief = None, text = OTPLocalizer.NoSecretChatAtAllOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.64000000000000001), command = self._ToontownChatManager__handleNoSecretChatAtAllOK)
            buttons.removeNode()
    ...
    def _ToontownChatManager__whisperScButtonPressed(self, avatarName, avatarId, playerId):
        if base.config.GetBool('want-qa-regression', 0):
