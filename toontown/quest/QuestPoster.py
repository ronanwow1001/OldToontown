...
class QuestPoster(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        optiondefs = (('relief', None, None), ('image', questCard, None), ('image_scale', (0.80000000000000004, 1.0, 0.57999999999999996), None), ('state', DGG.NORMAL, None))
    ...
    def showChoicePoster(self, questId, fromNpcId, toNpcId, rewardId, callback):
        ...
        if not base.cr.isPaid():
            if not questId == 401:
                if hasattr(quest, 'getLocation') or quest.getLocation() == 1000 or hoodId == 1000:
