...
class QuestChoiceGui(DirectFrame):
    ...
    def __init__(self):
        DirectFrame.__init__(self, relief = None, geom = DGG.getDefaultDialogGeom(), geom_color = Vec4(0.80000000000000004, 0.59999999999999998, 0.40000000000000002, 1), geom_scale = (1.8500000000000001, 1, 0.90000000000000002), geom_hpr = (0, 0, -90), pos = (-0.84999999999999998, 0, 0))
