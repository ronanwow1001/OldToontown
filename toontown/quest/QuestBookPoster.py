...
class QuestBookPoster(QuestPoster):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        optiondefs = (('relief', None, None), ('reverse', 0, None), ('mapIndex', 0, None), ('image', questCard, None), ('image_scale', (0.80000000000000004, 1.0, 0.57999999999999996), None), ('state', DGG.NORMAL, None))
        ...
        self.mapIndex = DirectLabel(parent = self.questFrame, relief = None, text = '%s' % self['mapIndex'], text_fg = (1, 1, 1, 1), text_scale = 0.035000000000000003, text_align = TextNode.ACenter, image = iconNP, image_scale = 0.29999999999999999, image_color = (1, 0, 0, 1), pos = (-0.29999999999999999, 0, 0.14999999999999999))
        self.mapIndex.hide()
        iconNP.removeNode()
        gui.removeNode()
