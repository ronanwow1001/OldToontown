...
class FishSellGUI(DirectFrame):
    ...
    def __init__(self, doneEvent):
        DirectFrame.__init__(self, relief = None, state = 'normal', geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (2.0, 1, 1.5), frameSize = (-1, 1, -1, 1), pos = (0, 0, 0), text = '', text_wordwrap = 26, text_scale = 0.059999999999999998, text_pos = (0, 0.65000000000000002))
        ...
        self.cancelButton = DirectButton(parent = self, relief = None, image = cancelImageList, pos = (0.29999999999999999, 0, -0.57999999999999996), text = TTLocalizer.FishGuiCancel, text_scale = TTLocalizer.FSGUIcancelButton, text_pos = (0, -0.10000000000000001), command = self._FishSellGUI__cancel)
        self.okButton = DirectButton(parent = self, relief = None, image = okImageList, pos = (0.59999999999999998, 0, -0.57999999999999996), text = TTLocalizer.FishGuiOk, text_scale = TTLocalizer.FSGUIokButton, text_pos = (0, -0.10000000000000001), command = self._FishSellGUI__sellFish)
        self.rewardDoubledJellybeanLabel = DirectLabel(text = '', text_fg = (1.0, 0.125, 0.125, 1.0), relief = None, pos = (0.45000000000000001, 0, -0.47999999999999998), scale = 0.070000000000000007)
        buttons.removeNode()
