    ...
    def setGenus(self, genus):
        ...
        if self.genus != None:
            ...
            for species in range(len(speciesList)):
                label = DirectLabel(parent = self, relief = None, state = DGG.NORMAL, pos = (0.059999999999999998, 0, startPos - species * offset), text = TTLocalizer.UnknownFish, text_fg = (0.20000000000000001, 0.10000000000000001, 0.0, 1), text_scale = TTLocalizer.GPgenus, text_align = TextNode.ALeft, text_font = ToontownGlobals.getInterfaceFont())
