...
class BingoCardCell(DirectButton, FSM.FSM):
    ...
    def __init__(self, cellId, fish, model, color, parent, **kw):
        ...
        optiondefs = (('relief', None, None), ('state', DGG.DISABLED, None), ('image', buttonToUse, None), ('image_color', self.color, None), ('image_hpr', (0, 90, 0), None), ('image_pos', (0, 0, 0), None), ('pressEffect', False, None))
