...
import random
MAX_AVATARS = 6
POSITIONS = (Vec3(-0.840167, 0, 0.35933300000000001), Vec3(0.0093334899999999998, 0, 0.306533), Vec3(0.86199999999999999, 0, 0.32929999999999998), Vec3(-0.86355400000000004, 0, -0.44565900000000003), Vec3(0.0099999900000000003, 0, -0.5181), Vec3(0.86490699999999998, 0, -0.44565900000000003))
...
class AvatarChooser(StateData.StateData):
    ...
    def load(self, isPaid):
        ...
        self.title = OnscreenText(TTLocalizer.AvatarChooserPickAToon, scale = TTLocalizer.ACtitle, parent = hidden, font = ToontownGlobals.getSignFont(), fg = (1, 0.90000000000000002, 0.10000000000000001, 1), pos = (0.0, 0.81999999999999995))
        quitHover = gui.find('**/QuitBtn_RLVR')
        self.quitButton = DirectButton(image = (quitHover, quitHover, quitHover), relief = None, text = TTLocalizer.AvatarChooserQuit, text_font = ToontownGlobals.getSignFont(), text_fg = (0.97699999999999998, 0.81599999999999995, 0.13300000000000001, 1), text_pos = TTLocalizer.ACquitButtonPos, text_scale = TTLocalizer.ACquitButton, image_scale = 1, image1_scale = 1.05, image2_scale = 1.05, scale = 1.05, pos = (1.0800000000000001, 0, -0.90700000000000003), command = self._AvatarChooser__handleQuit)
        self.logoutButton = DirectButton(relief = None, image = (quitHover, quitHover, quitHover), text = TTLocalizer.OptionsPageLogout, text_font = ToontownGlobals.getSignFont(), text_fg = (0.97699999999999998, 0.81599999999999995, 0.13300000000000001, 1), text_scale = TTLocalizer.AClogoutButton, text_pos = (0, -0.035000000000000003), pos = (-1.1699999999999999, 0, -0.91400000000000003), image_scale = 1.1499999999999999, image1_scale = 1.1499999999999999, image2_scale = 1.1799999999999999, scale = 0.5, command = self._AvatarChooser__handleLogoutWithoutConfirm)
        self.logoutButton.hide()
        gui.removeNode()
        gui2.removeNode()
        newGui.removeNode()
