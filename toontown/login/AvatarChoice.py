...
NAME_POSITIONS = ((0, 0, 0.26000000000000001), (-0.029999999999999999, 0, 0.25), (0, 0, 0.27000000000000002), (-0.029999999999999999, 0, 0.25), (0.029999999999999999, 0, 0.26000000000000001), (0, 0, 0.26000000000000001))
DELETE_POSITIONS = ((0.187, 0, -0.26000000000000001), (0.31, 0, -0.16700000000000001), (0.23100000000000001, 0, -0.24099999999999999), (0.314, 0, -0.186), (0.24299999999999999, 0, -0.23300000000000001), (0.28000000000000003, 0, -0.20699999999999999))
...
class AvatarChoice(DirectButton):
    ...
    def __init__(self, av = None, position = 0, paid = 0, okToLockout = 1):
        ...
        if self.mode is AvatarChoice.MODE_LOCKED:
            ...
            logo = DirectFrame(state = DGG.DISABLED, parent = self, relief = None, image = upsellTex, image_scale = (0.90000000000000002, 0, 0.90000000000000002), image_pos = (0, 0, 0), scale = 0.45000000000000001)
            ...
            self.nameText = DirectLabel(parent = self, relief = None, scale = 0.080000000000000002, pos = NAME_POSITIONS[position], text = self.name, hpr = (0, 0, NAME_ROTATIONS[position]), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), text_wordwrap = 8, text_font = ToontownGlobals.getToonFont(), state = DGG.DISABLED)
            ...
            self.statusText = DirectLabel(parent = self, relief = None, scale = 0.089999999999999997, pos = (0, 0, -0.23999999999999999), text = '', text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), text_wordwrap = 7.5, text_scale = TTLocalizer.ACstatusText, text_font = ToontownGlobals.getToonFont(), state = DGG.DISABLED)
            if self.wantName != '':
    ...
    def verifyDeleteWithPassword(self):
        ...
        if self.deleteWithPasswordFrame == None:
            ...
            self.deleteWithPasswordFrame = DirectFrame(pos = (0.0, 0.10000000000000001, 0.20000000000000001), parent = aspect2dp, relief = None, image = DGG.getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.3999999999999999, 1.0, 1.0), text = deleteText, text_wordwrap = 19, text_scale = TTLocalizer.ACdeleteWithPasswordFrame, text_pos = (0, 0.25), textMayChange = 1, sortOrder = NO_FADE_SORT_INDEX)
            ...
            if self.deleteWithPassword:
                ...
                self.passwordEntry = DirectEntry(parent = self.deleteWithPasswordFrame, relief = None, image = nameBalloon, image1_color = (0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1.0), image_pos = (0.0, 0.0, -0.45000000000000001), scale = 0.064000000000000001, pos = (0.0, 0.0, -0.20000000000000001), width = ToontownGlobals.maxLoginWidth, numLines = 2, focus = 1, cursorKeys = 1, obscured = 1, command = self._AvatarChoice__handleDeleteWithPasswordOK)
