...
class TownBattleToonPanel(DirectFrame):
    ...
    def __init__(self, id):
        ...
        self.sosText.hide()
        self.fireText = DirectLabel(parent = self, relief = None, pos = (0.10000000000000001, 0, 0.014999999999999999), text = TTLocalizer.TownBattleToonFire, text_scale = 0.059999999999999998)
        self.fireText.hide()
