...
def __createSlideshowMultiTrack(lure, npcs = []):
    ...
    propTrack.append(Func(slideShowProp.setScale, Point3(0.10000000000000001, 0.10000000000000001, 0.10000000000000001)))
    ...
    propTrack.append(LerpScaleInterval(nodePath = slideShowProp, scale = Point3(1.0, 1.0, 0.10000000000000001), duration = shrinkDuration))
    ...
    tracks.append(getSoundTrack('TL_presentation.mp3', delay = 2.2999999999999998, node = toon))
