...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.tip = DirectLabel(guiId = 'ToontownLoadingScreenTip', parent = self.banner, relief = None, text = '', text_scale = TTLocalizer.TLStip, textMayChange = 1, pos = (-1.2, 0.0, 0.10000000000000001), text_fg = (0.40000000000000002, 0.29999999999999999, 0.20000000000000001, 1), text_wordwrap = 13, text_align = TextNode.ALeft)
