...
class NewsPageButtonManager(FSM.FSM):
    ...
    def load(self):
        ...
        bounce1Pos = VBase3(newPos.getX(), newPos.getY(), newPos.getZ() + 0.021999999999999999)
        bounce2Pos = VBase3(newPos.getX(), newPos.getY(), newPos.getZ() + 0.014999999999999999)
        bounceIval = Sequence(LerpPosInterval(self.newIssueButton, 0.10000000000000001, bounce1Pos, blendType = 'easeOut'), LerpPosInterval(self.newIssueButton, 0.10000000000000001, newPos, blendType = 'easeIn'), LerpPosInterval(self.newIssueButton, 0.070000000000000007, bounce2Pos, blendType = 'easeOut'), LerpPosInterval(self.newIssueButton, 0.070000000000000007, newPos, blendType = 'easeIn'))
        self._NewsPageButtonManager__blinkIval = Sequence(Func(self._NewsPageButtonManager__showOpenEyes), Wait(2), bounceIval, Wait(0.5), Func(self._NewsPageButtonManager__showClosedEyes), Wait(0.10000000000000001), Func(self._NewsPageButtonManager__showOpenEyes), Wait(0.10000000000000001), Func(self._NewsPageButtonManager__showClosedEyes), Wait(0.10000000000000001))
