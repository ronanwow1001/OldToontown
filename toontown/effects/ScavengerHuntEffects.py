...
class ScavengerHuntEffect:
    ...
    def __init__(self, beanAmount):
        ...
        self.npRoot = DirectFrame(parent = aspect2d, relief = None, scale = 0.75, pos = (0, 0, 0.59999999999999998))
        if beanAmount > 0:
            ...
            self.countLabel = DirectLabel(parent = self.jar, relief = None, text = '+0', text_pos = (0.02, -0.20000000000000001), text_scale = 0.25, text_fg = (0.94999999999999996, 0.0, 0, 1), text_font = ToontownGlobals.getSignFont())
...
class TrickOrTreatTargetEffect(ScavengerHuntEffect):
    ...
    def attemptFailedMsg(self):
        pLabel = DirectLabel(parent = self.npRoot, relief = None, pos = (0.0, 0.0, -0.14999999999999999), text = TTLocalizer.TrickOrTreatMsg, text_fg = (0.94999999999999996, 0.5, 0.0, 1.0), text_scale = 0.12, text_font = ToontownGlobals.getSignFont())
...
class WinterCarolingEffect(ScavengerHuntEffect):
    ...
    def attemptFailedMsg(self):
        pLabel = DirectLabel(parent = self.npRoot, relief = None, pos = (0.0, 0.0, -0.14999999999999999), text = TTLocalizer.WinterCarolingMsg, text_fg = (0.90000000000000002, 0.90000000000000002, 1.0, 1.0), text_scale = 0.12, text_font = ToontownGlobals.getSignFont())
