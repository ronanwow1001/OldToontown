...
def shootFireworkRing(x, y, z, color1, color2, amp):
    ...
    force0 = LinearSourceForce(Point3(x, y, z), LinearDistanceForce.FTONEOVERR, 0.10000000000000001, 1.1000000000000001 * amp, 1)
    force0.setActive(1)
    f0.addForce(force0)
...
def shootFireworkCircleGeneric(x, y, z, color1, color2, amp, poolSize):
    ...
    force1 = LinearSinkForce(Point3(x, y, z - 100), LinearDistanceForce.FTONEOVERRSQUARED, 2.0, 0.29999999999999999 * amp * 0.10000000000000001, 1)
    force1.setActive(1)
