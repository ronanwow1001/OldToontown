...
global InterfaceFont, InterfaceFontPath, SignFont, SignFontPath, FancyFont, FancyFontPath, NametagFonts, NametagFontPaths, DialogClass, GlobalDialogClass, ProductPrefix
