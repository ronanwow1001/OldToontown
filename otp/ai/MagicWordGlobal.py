...
CATEGORY_GRAPHICAL = MagicWordCategory('Graphical debugging', defaultAccess=500)
CATEGORY_GUI = MagicWordCategory('GUI debugging', defaultAccess=500)
CATEGORY_MOBILITY = MagicWordCategory('Mobility cheats', defaultAccess=500)
CATEGORY_OVERRIDE = MagicWordCategory('Override cheats', defaultAccess=500)
CATEGORY_CHARACTERSTATS = MagicWordCategory('Character-stats cheats', defaultAccess=500)
CATEGORY_DEBUG = MagicWordCategory('Debug cheats', defaultAccess=500)
CATEGORY_MODERATION = MagicWordCategory('Moderation commands', defaultAccess=500)
